...
class EEGStreamState:
    def __init__(self, inlet: StreamInlet, config, mode="p300", logger=None):
        self.inlet = inlet
        self.config = config
        self.logger = logger
        self.mode = mode
        ...
        try:
            ...
            if not self.first_chunk_processed:
                ...
                if self.mode == "p300":
                    ...
                    self.subset_indices = [
                        self.channel_names.index(ch) for ch in p300_raw.ch_names
                    ]
                    self.channel_names = p300_raw.ch_names
                    self.final_indices = [
